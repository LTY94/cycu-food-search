...
LANDMARKS = {
    ...
    "知行領航館": (24.95860304296191, 121.24619166748059),
...
def calculate_real_distance(coord1, coord2):
    ...
    # 原本會穿牆的直線距離
    straight_line_dist = math.sqrt(d_lat**2 + d_lng**2)
    
    # 🌟 乘以 1.4 倍，完美模擬真實街道轉彎與步行的距離
    walking_dist = straight_line_dist * 1.4
    
    return int(walking_dist)
